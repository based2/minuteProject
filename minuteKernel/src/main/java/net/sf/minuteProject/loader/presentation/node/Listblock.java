...
public class Listblock extends AbstractConfiguration{

   private Dictionary _dictionary;
   private String _name;
   private String _id;
   private Boolean _isForm;
   private String _numberOfLineMax;
   private Boolean _hasPagination;
   ...
   public String getNumberoflinemax() {
      return _numberOfLineMax;
   }
	
   public void setNumberoflinemax (String _numberOfLineMax) {
      this._numberOfLineMax = _numberOfLineMax;
   }
   ...
   public void setHaspagination (Boolean _hasPagination) {
